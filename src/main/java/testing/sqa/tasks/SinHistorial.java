...
import static testing.sqa.userinterfaces.SinHistorial.*;


public class SinHistorial implements Task {
    @Override
    ...
    public static SinHistorial socialMedia() {
        return Instrumented.instanceOf(SinHistorial.class).withProperties();
}}